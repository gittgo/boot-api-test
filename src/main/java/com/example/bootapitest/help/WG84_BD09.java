...
public class WG84_BD09 {
    ...
    public static void main(String[] args) {
        contextLoads3(29.5744,120.8002);
    }
     ...
     * @returns {*[]}
     */
    public static LocateInfo contextLoads3(double lat,double lng) {
        LocateInfo info = new LocateInfo();
        if (GCJ02_WGS84.outOfChina(lat, lng)) {
            info.setChina(false);
